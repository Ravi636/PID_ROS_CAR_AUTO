...
from nav_msgs.msg import Path, Odometry  # Import Path and Odometry Message types we use these to listen to messages of this type 
from ackermann_msgs.msg import AckermannDriveStamped  # This is the final control output message is AckermannDrive type
import math  # for math functions
import tf    # allows conversion of data from Euler to Quaternion and vice-versa 
import sched 
import time   
import signal  
import sys

speed = 0.35  # change this value only for tinkering. 
...
def odomCallback(msg):                     # This function gets called everytime the car odometery data is published
    ...
    if ( distance_to_goal < 0.4 ):    #i.e if car has reached goal
